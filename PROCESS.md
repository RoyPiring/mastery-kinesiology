...
**Catalog: `ideas/mastery-kinesiology-100/mastery-kinesiology-100.md`**

Do-first order lives in `ideas/mastery-kinesiology-100/mastery-kinesiology-100-RANKING.md`. Start at rank 1 and go in order.

| Rank | Start with |
|------|------------|
| 1 | The Kinesiology Concept Map |
| 2 | Science or Practice: The Decision |
| 3 | Functional Anatomy |
| 4 | The Sub-Disciplines Survey |
...
TWO HONEST ROUTES. To PRACTICE you need a relevant degree plus professional certifications, and NO PhD. To do funded RESEARCH you need the PhD. A certification is a CREDENTIAL, not a license, and the CSCS requires a bachelor's rather than a master's.


## Safety layer (binding)

- **Real bodies raise the bar.** Any testing on a person needs PAR-Q+ pre-participation screening and appropriate risk stratification.
- **Qualified supervision is required** for exercise testing, and clinician oversight where a condition or symptom is in scope.
- **A certification is a credential, not a license**, and does not authorize clinical practice.
- **Clinical entries are guideline-translation study builds**, never assessment or treatment of a real client.


## The binding contract (what every project here must carry)

- **Point of view.** PoV-M, the learner-principal. Every payload is written as someone building command of kinesiology, weighted to the practical and measured side by doing, never as a textbook narrator. The persona is binding on all payloads (rule 1).
